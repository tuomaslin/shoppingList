# Embedded Tomcat -projektipohja [![Build Status](https://github.com/ohjelmointi2/embedded-tomcat-template/actions/workflows/maven.yml/badge.svg)](https://github.com/ohjelmointi2/embedded-tomcat-template/actions)
